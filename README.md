QuillPHP is a PHP API framework with a Rust core — [**quill-core**](https://github.com/quillphp/quill-core) owns TCP, routing, validation, and JSON serialisation. PHP handles your handler logic. Nothing else.
